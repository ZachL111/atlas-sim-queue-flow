"""Regression checks for the atlas-sim-queue-flow casebook."""
...
from casebook.harness import assert_expected, atlas_sim_queue_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(atlas_sim_queue_flow_summary(), assert_expected())
